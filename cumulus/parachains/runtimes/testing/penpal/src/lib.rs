...
parameter_types! {
	/// The asset ID for the asset that we use to pay for message delivery fees to relay chain.
	...
	pub SiblingFeeAssetId: AssetLocationId = AssetLocationId(xcm_config::PenpalNativeCurrency::get());
