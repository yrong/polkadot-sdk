...
| 10.10 | POC runtime & test milestones | 🔶 | Milestones 1–5 ✅. Zombienet config added: `cumulus/zombienet/examples/speculative_messaging_poc/network.toml` — two Penpal instances (para 2000 sender, para 2001 receiver) on Rococo-local, receiver started with `--speculative-sender 2000=ws://127.0.0.1:9955`. Milestones 6–8 (live network verification) pending actual run. |
