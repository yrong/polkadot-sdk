...
use snowbridge_verification_primitives::receipt_helper::receipt_index_from_proof;
use sp_core::U256;
use sp_std::vec;

pub fn make_register_token_message() -> EventFixture {
	let receipt_proof = vec![
	...
	let receipt_index = receipt_index_from_proof(&receipt_proof)
