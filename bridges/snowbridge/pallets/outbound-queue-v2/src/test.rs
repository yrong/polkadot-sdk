...
fn encode_unlock_message() {
	...
	assert_eq!(hex!("").to_vec(), message_abi_encoded)
}
...
fn encode_register_pna() {
	...
	let message_abi_encoded = encode_mock_message(message);
	println!("{}", HexDisplay::from(&message_abi_encoded));
	assert_eq!(hex!("").to_vec(), message_abi_encoded)
}
